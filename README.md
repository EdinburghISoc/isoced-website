...
├── fixr.html         # Events calendar 2026–27 + official Fixr ticketing
├── prayer.html       # Live prayer times, spaces, halal food
...
1. Create a new GitHub repository and push these files to it:
   ...
   git init
   git add .
   git commit -m "Initial commit: Edinburgh Isoc website"
   git branch -M main
...
- **Event dates:** exact dates are confirmed each term; update the date chips in `fixr.html` as needed.
